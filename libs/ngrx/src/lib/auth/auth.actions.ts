...
export class CheckAuthAction extends NgRxAction<any> {
  type = AuthActions.CHECK_AUTH;
}
export class CheckAuthSuccessAction extends NgRxAction<any> {
  type = AuthActions.CHECK_AUTH_SUCCESS;
}
export class CheckAuthNoUserSuccessAction extends NgRxAction<IAuthState> {
  type = AuthActions.CHECK_AUTH_NO_USER;
}

export class LoginAction extends NgRxAction<any> {
  type = AuthActions.LOGIN;
}
export class LoginSuccessAction extends NgRxAction<APIResponse> {
...
export class CreateAction extends NgRxAction<any> {
  type = AuthActions.CREATE;
}
export class CreateSuccessAction extends NgRxAction<APIResponse> {
  type = AuthActions.CREATE_SUCCESS;
}

export class TokenSaveAction extends NgRxAction<any> {
  type = AuthActions.TOKEN_SAVE;
}
export class TokenSaveSuccessAction extends NgRxAction<any> {
  type = AuthActions.TOKEN_SAVE_SUCCESS;
}

export class TokenDeleteAction extends NgRxAction<any> {
  type = AuthActions.TOKEN_DELETE;
}
export class TokenDeleteSuccessAction extends NgRxAction<any> {
