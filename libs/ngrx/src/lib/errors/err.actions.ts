...
export class ErrorDisplayAction extends NgRxAction<any> {
  type = ErrorActions.ERROR_DISPLAY;
}
export class ErrorDisplaySuccessAction extends NgRxAction<any> {
  type = ErrorActions.ERROR_DISPLAY_SUCCESS;
}
export class ErrorAction extends NgRxAction<any> {
  type = ErrorActions.ERROR_DISPLAY_FAILED;
}
